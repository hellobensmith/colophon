...
import { parseSource } from "../src/ingest.ts";
import type { ScriptureDocument } from "../src/document.ts";
...
function buildTextModule(doc: ScriptureDocument): string {
...
function buildIndexModule(doc: ScriptureDocument): string {
 ...
 */
function fingerprint(doc: ScriptureDocument): string {
...
function buildMetaModule(doc: ScriptureDocument): string {
 ...
 */
function report(doc: ScriptureDocument): void {
